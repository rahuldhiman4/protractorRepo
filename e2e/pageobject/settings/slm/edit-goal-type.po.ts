...
class GoalTypeConfigEditPage {
    ...
    selectors = {
        ...
        goalType: '[rx-view-component-id="f766b2ae-1205-4c7b-bf5b-b6ac1190fd7c"] .ui-select-container',
        statusDropDown: '[rx-view-component-id="57b81b04-b4ff-4624-a04f-fceaa4a7eb08"] .ui-select-match',
        goalTypeStatusDropDown: '[rx-view-component-id="57b81b04-b4ff-4624-a04f-fceaa4a7eb08"] .ui-select-container',
    }
