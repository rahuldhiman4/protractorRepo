...
import caseTemplateApi from "../api/create.recordinstance.api";
...
describe('Login and create case from API', () => {
    ...
    xit('should create case template', async () => {
        ...
        var newCaseTemplate = await caseTemplateApi.createCaseTemplateWithRequiredFields("My New CaseTemplate9", 'draft');
        ...
        var newCaseTemplate = await caseTemplateApi.createCaseTemplateWithRequiredFields("My New CaseTemplate10", 'active');
