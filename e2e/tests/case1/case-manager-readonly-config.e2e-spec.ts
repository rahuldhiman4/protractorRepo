...
describe('Case Manager Read-only Config', () => {
    ...
    it('[DRDMV-18063]: Check Case manager is not able to perform Create Update Delete operation on Email->Template', async () => {
        ...
        expect(await editEmailTemplatePage.isLocalizedMessageButtonEnabled()).toBeTruthy('Localized Message button is enabled');
        await editEmailTemplatePage.clickOnBodyCheckbox();
        expect(await editEmailTemplatePage.isEditButtonEnabled()).toBeTruthy('Edit Body button is enabled');
        await editEmailTemplatePage.clickOnSubjectCheckbox();
        expect(await editEmailTemplatePage.isEditButtonEnabled()).toBeTruthy('Edit Subject button is enabled');
    });
    ...
    it('[DRDMV-18061]: Check Case manager is not able to perform Create Update and Delete operation on Email->Acknowledgement template', async () => {
        ...
        expect(await editAcknowledementTemplatePage.isLocalizedMessageButtonEnabled()).toBeTruthy('Localized Message button is enabled');
        await editAcknowledementTemplatePage.clickOnBodyCheckbox();
        expect(await editAcknowledementTemplatePage.isEditButtonEnabled()).toBeTruthy('Edit Body button is enabled');
        await editAcknowledementTemplatePage.clickOnSubjectCheckbox();
        expect(await editAcknowledementTemplatePage.isEditButtonEnabled()).toBeTruthy('Edit Subject button is enabled');
    });
