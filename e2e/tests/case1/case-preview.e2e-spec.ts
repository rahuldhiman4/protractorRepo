...
describe("Case Preview", () => {
    ...
    it('[DRDMV-13666,DRDMV-13672]: Create a Quick Case and Click on Back button on Case Preview blade', async () => {
        ...
        await expect(await utilityCommon.isPopupMsgsMatches(msgs)).toBeTruthy("Success Message not present")
    ...
    it('[DRDMV-13644]: Create a Case via Quick Case by pinning articles and cases and check Case Preview on save', async () => {
        ...
        expect(await casePreviewPo.isAssigneeDisplayed('Fritz Schulz')).toBeTruthy('failureMsg: Assignee name is missing');
        expect(await casePreviewPo.isAssignedGroupDisplayed('Facilities')).toBeTruthy('failureMsg: Assigned group name is missing');
