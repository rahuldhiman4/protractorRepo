...
describe('PIN Validation Create Case', () => {
    ...
    describe('[DRDMV-10601,DRDMV-10602,DRDMV-10606,DRDMV-10607,DRDMV-10610]:Case creation via Quick Case ,Template validation is OPTIONAL', async () => {
        let casetemplatePsilon1, newCaseTemplate;
        let randomStr = [...Array(10)].map(i => (~~(Math.random() * 36)).toString(36)).join('');
        beforeAll(async () => {
            casetemplatePsilon1 = {
        ...
        it('[DRDMV-10601,DRDMV-10602,DRDMV-10606,DRDMV-10607,DRDMV-10610]:Case creation via Quick Case ,Template validation is OPTIONAL', async () => {
            await navigationPage.signOut();
            await loginPage.login('werusha');
            await navigationPage.gotoCreateCase();
            await createCasePo.selectRequester('gwixillian');
