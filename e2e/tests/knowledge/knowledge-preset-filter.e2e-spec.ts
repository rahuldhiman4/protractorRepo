...
describe('Knowledge Console Preset Filter', () => {
    ...
    it('[3663]: Validate the All Articles In Last 1 month filter after applying and removing the filter', async () => {
        ...
        await dbConnectVar.query(`UPDATE t4531 SET c3 = '${dateEpochValueArticle1}' WHERE c302300507 = '${displayId1}'`);
        ...
        await dbConnectVar.query(`UPDATE t4531 SET c3 = '${dateEpochValueArticle2}' WHERE c302300507 = '${displayId2}'`);
        ...
        await dbConnectVar.query(`UPDATE t4531 SET c3 = '${dateEpochValueArticle3}' WHERE c302300507 = '${displayId3}'`);
        ...
        await dbConnectVar.query(`UPDATE t4531 SET c3 = '${dateEpochValueArticle4}' WHERE c302300507 = '${displayId4}'`);
