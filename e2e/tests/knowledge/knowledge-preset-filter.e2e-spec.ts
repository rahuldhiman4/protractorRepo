...
describe('Knowledge Console Preset Filter', () => {
    ...
    beforeAll(async () => {
        ...
        browser.sleep(9000); //New user is created above, waiting for its backend access preperation
    ...
    it('[DRDMV-20895]: Validate the All Articles In Last 1 month filter after applying and removing the filter', async () => {
        ...
        await dbConnectVar.query(`UPDATE t685 SET c3 = '${dateEpochValueArticle1}' WHERE c302300507 = '${displayId1}'`);
        ...
        await dbConnectVar.query(`UPDATE t685 SET c3 = '${dateEpochValueArticle2}' WHERE c302300507 = '${displayId2}'`);
