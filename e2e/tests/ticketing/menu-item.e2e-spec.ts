...
describe('Menu Item', () => {
    ...
    it('DRDMV-16105: [UI] "[Menu Items] - Update records', async () => {
        ...
        expect(await editMenuItemsConfigPo.isStatusDropDownValueMatch(statusdropDown1)).toBeTruthy('wrong column headers');
        ...
        expect(await editMenuItemsConfigPo.isStatusDropDownValueMatch(statusDropDown2)).toBeTruthy('wrong column headers');
