...
describe('Dynamic Confidentials Data', () => {
    ...
    describe('[DRDMV-15006,DRDMV-15024,DRDMV-15025]: [DesignTime] Add confidential support group on case template', async () => {
        ...
        it('[DRDMV-15006,DRDMV-15024,DRDMV-15025]: [DesignTime] Add confidential support group on case template', async () => {
            ...
            await viewCasetemplatePo.selectTab('Case Access');
            expect(await viewCasetemplatePo.isConfidentialSupportGroupAccess()).toBeFalsy();

        });
    });

    //ankagraw
    describe('[DRDMV-15065]: Validation of Confidential fields in Dynamic Field Group on Case', async () => {
        let caseTemplateData, caseId, randomStr = [...Array(4)].map(i => (~~(Math.random() * 36)).toString(36)).join('');
        beforeAll(async () => {
            caseTemplateData = {
    ...
    describe('[DRDMV-15026,DRDMV-15027,DRDMV-15013]: [DesignTime] Add confidential support group on case template - Global Company', async () => {
        let caseTemplateData, randomStr = [...Array(4)].map(i => (~~(Math.random() * 36)).toString(36)).join('');
        beforeAll(async () => {
            caseTemplateData = {
                "templateName": randomStr + 'caseTemplateName',
        ...
        it('[DRDMV-15026,DRDMV-15027,DRDMV-15013]: [DesignTime] Add confidential support group on case template - Global Company', async () => {
            ...
            await viewCasetemplatePo.selectTab('Case Access');
            await viewCasetemplatePo.clickConfidentialSupportGroupAccess();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupDropDownPresent("AU Support 1")).toBeTruthy();
            await viewCasetemplatePo.selectConfidentialSupportGroupDropDown("AU Support 1");
            await viewCasetemplatePo.clickAddConfidentialSupportGroup();
            await viewCasetemplatePo.clickConfidentialSupportGroupAccess();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupDropDownPresent("Sensitive Personal Data (HR)")).toBeTruthy();
            await viewCasetemplatePo.selectConfidentialSupportGroupDropDown("Sensitive Personal Data (HR)");
        ...
        it('[DRDMV-15026,DRDMV-15027,DRDMV-15013]: [DesignTime] Add confidential support group on case template - Global Company', async () => {
            await viewCasetemplatePo.clickAddConfidentialSupportGroup();
            await viewCasetemplatePo.clickConfidentialSupportGroupAccess();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupDropDownPresent("AU Support 2")).toBeTruthy();
            await viewCasetemplatePo.selectConfidentialSupportGroupDropDown("AU Support 2");
            await viewCasetemplatePo.clickAddConfidentialSupportGroup();
            await viewCasetemplatePo.clickConfidentialSupportGroupAccess();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupDropDownPresent("AU Support 3")).toBeTruthy();
            await viewCasetemplatePo.selectConfidentialSupportGroupDropDown("AU Support 3");
            await viewCasetemplatePo.clickAddConfidentialSupportGroup();
            await viewCasetemplatePo.clickConfidentialSupportGroupAccess();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupDropDownPresent("AU Support 4")).toBeTruthy();
            await viewCasetemplatePo.selectConfidentialSupportGroupDropDown("AU Support 4");
            await viewCasetemplatePo.clickAddConfidentialSupportGroup();
        });

        it('[DRDMV-15026,DRDMV-15027,DRDMV-15013]: [DesignTime] Add confidential support group on case template - Global Company', async () => {
            await viewCasetemplatePo.clickConfidentialSupportGroupAccess();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupDropDownPresent("Facilities")).toBeTruthy();
            await viewCasetemplatePo.selectConfidentialSupportGroupDropDown("Facilities");
            await viewCasetemplatePo.clickConfidentialWriteSupportGroupAccess();
            await viewCasetemplatePo.clickAddConfidentialSupportGroup();
            await viewCasetemplatePo.clickConfidentialSupportGroupAccess();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupDropDownPresent("CA Support 1")).toBeTruthy();
            await viewCasetemplatePo.selectConfidentialSupportGroupDropDown("CA Support 1");
            await viewCasetemplatePo.clickConfidentialWriteSupportGroupAccess();
            await viewCasetemplatePo.clickAddConfidentialSupportGroup();
        });
        it('[DRDMV-15026,DRDMV-15027,DRDMV-15013]: [DesignTime] Add confidential support group on case template - Global Company', async () => {
            await viewCasetemplatePo.clickConfidentialSupportGroupAccess();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupDropDownPresent("CA Support 2")).toBeTruthy();
            await viewCasetemplatePo.selectConfidentialSupportGroupDropDown("CA Support 2");
            await viewCasetemplatePo.clickConfidentialWriteSupportGroupAccess();
            await viewCasetemplatePo.clickAddConfidentialSupportGroup();
            await viewCasetemplatePo.clickConfidentialSupportGroupAccess();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupDropDownPresent("CA Support 3")).toBeTruthy();
            await viewCasetemplatePo.selectConfidentialSupportGroupDropDown("CA Support 3");
            await viewCasetemplatePo.clickConfidentialWriteSupportGroupAccess();
            await viewCasetemplatePo.clickAddConfidentialSupportGroup();
            await viewCasetemplatePo.clickConfidentialSupportGroupAccess();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupDropDownPresent("Employee Relations Sensitive Data Access")).toBeTruthy();
            await viewCasetemplatePo.selectConfidentialSupportGroupDropDown("Employee Relations Sensitive Data Access");
            await viewCasetemplatePo.clickConfidentialWriteSupportGroupAccess();
            await viewCasetemplatePo.clickAddConfidentialSupportGroup();
        });
        it('[DRDMV-15026,DRDMV-15027,DRDMV-15013]: [DesignTime] Add confidential support group on case template - Global Company', async () => {
            ...
            await viewCasetemplatePo.selectConfidentialSupportGroupDropDown("Employee Relations Sensitive Data Access");
            await viewCasetemplatePo.clickAddConfidentialSupportGroup();
            expect(await viewCasetemplatePo.getSupportGroupWarningMessage()).toContain("The group already exists in the access list.");
            ...
            await viewCasetemplatePo.selectTab('Case Access');
            expect(await viewCasetemplatePo.isConfidentialSupportGroupValueTextDisplayed("Facilities")).toBeTruthy();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupValueTextDisplayed("AU Support 1")).toBeTruthy();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupValueTextDisplayed("AU Support 2")).toBeTruthy();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupValueTextDisplayed("AU Support 3")).toBeTruthy();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupValueTextDisplayed("AU Support 4")).toBeTruthy();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupValueTextDisplayed("CA Support 1")).toBeTruthy();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupValueTextDisplayed("CA Support 2")).toBeTruthy();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupValueTextDisplayed("CA Support 3")).toBeTruthy();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupValueTextDisplayed("Employee Relations Sensitive Data Access")).toBeTruthy();
            expect(await viewCasetemplatePo.isConfidentialSupportGroupValueTextDisplayed("Sensitive Personal Data (HR)")).toBeTruthy();
        });
    });

    //ankagraw
    describe('[DRDMV-15041]: [RunTime]Create Case with template which has confidential fields with Requester source of information', async () => {
