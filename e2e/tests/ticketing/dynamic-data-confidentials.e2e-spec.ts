...
describe('Dynamic Confidentials Data', () => {
    ...
    describe('[4487,4486,4492]: [DesignTime] Add confidential support group on case template - Global Company', async () => {
        ...
        it('[4487,4486,4492]: [DesignTime] Add confidential support group on case template - Global Company', async () => {
            ...
            expect(await accessTabPo.isAccessTypeOfEntityDisplayed('IN Support 3', 'Read')).toBeTruthy('FailuerMsg3: Support Group is missing');
            expect(await accessTabPo.isAccessTypeOfEntityDisplayed('LA Support 1', 'Read')).toBeTruthy('FailuerMsg4: Support Group is missing');
            expect(await accessTabPo.isAccessTypeOfEntityDisplayed('LA Support 2', 'Write')).toBeTruthy('FailuerMsg5: Support Group is missing');
            expect(await accessTabPo.isAccessTypeOfEntityDisplayed('LA Support 3', 'Write')).toBeTruthy('FailuerMsg6: Support Group is missing');
            expect(await accessTabPo.isAccessTypeOfEntityDisplayed('Sensitive Personal Data (HR)', 'Read')).toBeTruthy('FailuerMsg7: Support Group is missing');
            expect(await accessTabPo.isAccessTypeOfEntityDisplayed('Employee Relations Sensitive Data Access', 'Write')).toBeTruthy('FailuerMsg8: Support Group is missing');
            await viewCasetemplatePo.clickBackArrowBtn();
        });
    });
