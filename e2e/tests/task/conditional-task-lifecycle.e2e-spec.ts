...
describe('Conditional Task Life Cycle', () => {
    ...
    describe('[DRDMV-15000]: [Task] - Adhoc task in Case with multiple Series and parallel tasks with condition', () => {
        ...
        it('[DRDMV-15000]: Validate the status of Task Activities', async () => {
            ...
            expect(await activityPage.isTextPresentInActivityLog('Completed')).toBeTruthy();
            expect(await activityPage.isTextPresentInActivityLog('Successful')).toBeTruthy();
            expect(await activityPage.isTextPresentInActivityLog(taskDisplayIds[0])).toBeTruthy();
            expect(await activityPage.isTextPresentInActivityLog(taskDisplayIds[1])).toBeTruthy();
        });
    });
