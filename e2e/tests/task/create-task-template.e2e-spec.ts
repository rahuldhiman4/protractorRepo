...
describe('Create Task Template', () => {
    ...
    it('[DRDMV-5326]: [Permission] [Task Template] Access to Activity Feed records of the Task created using template', async () => {
        ...
        await changeAssignmentBladePo.selectAssignee('Adam Warlock');
        ...
        await changeAssignmentBladePo.selectAssigneeAsSupportGroup('US Support 3');
        await changeAssignmentBladePo.clickOnAssignButton();
        await editTaskPo.clickOnSaveButton();
        await expect(activityTabPo.getAllTaskActivity('US Support 3')).toContain('US Support 3');
